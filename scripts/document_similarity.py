...
def main():
    ...
    # 제목 처리
    #
    text_list = new_sub_titles
    input_embeddings = semantic_search_model.get_embedding(text_list)
    ...
    warning_list = []
    for sub_title, title_similarity, content_similarity in zip(sub_titles, title_similarities, content_similarities):
        # get top 1
        ...
        if title_score >= 0.85:
            ...
            if top_content_score >= 0.85:
                ...
                if top_title_idx == top_content_idx:
                    ...
                    warning_list.append((sub_title, reference_titles[top_title_idx], title_score, content_score, top_content_score))
